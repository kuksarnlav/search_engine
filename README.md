...
- Testing framework: [***GoogleTest***](https://github.com/google "Visit the github webpage with the framework")
- External library: [***JSON for Modern C++***](https://github.com/nlohmann/json "Visit the library github webpage")
